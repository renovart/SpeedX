...
class RobotCar:
    ...
    def __init__(self):
        ...
        self.display2 = self.driver.getDevice("display2")
        self.display.attachCamera(self.camera)
        self.display2.attachCamera(self.camera1)  # show camera image
        ...
        self.obstacle_sound = pygame.mixer.Sound(r'C:\Users\Emmanuel\Desktop\Graduation\vehicles\controllers\obstacle_detect\Warning.wav')
    ...
    def calcObstacleAngleDist(self, lidar_data):
        ...
        if collision_count == 0 or obstacle_dist > collision_count * OBSTACLE_DIST_MAX:
            ...
            if abs(obstacle_dist * math.sin(obstacle_angle)) < 0.5 * self.CAR_WIDTH + OBSTACLE_MARGIN:
                ...
                return self.UNKNOWN, self.UNKNOWN
    def play_sound(self):
        print("Playing sound for obstacle detection")
        ...
        while self.driver.step() != -1:
            ...
            if step % int(self.TIME_STEP/ BASIC_TIME_STEP) == 0:
                ...
                if  RobotCar.current_speed > 40:
                    ...
                    STOP_DIST = 14  # Stopping distance [m] when speed is below 30
