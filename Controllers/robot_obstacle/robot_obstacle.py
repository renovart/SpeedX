...
class RobotCar:
    ...
    def run(self):
        ...
        stop = False  # Initialize stop here
        step = 0
        ...
        while self.driver.step() != -1:
            ...
            if avoid_obstacle:
                ...
                self.driver.setSteeringAngle(0.5)  # Steer right to avoid obstacle
                avoid_obstacle = False  # Reset the flag after taking avoiding action
            else:
                if stop:
                    print("Stop!")
                    self.driver.setCruisingSpeed(0)
                ...
                if step % int(self.TIME_STEP / BASIC_TIME_STEP) == 0:
                    ...
                    obstacle_detected = any(dist < STOP_DIST for dist in lidar_data)
