...
class  RobotCar () : 
    ...
    def  __init__ (self) :   
        ...
        #self.camera_window_name = "Camera Image"
    ...
    def calcSteeringAngle(self, image):
        ...
        MAX_STEER_ANGLE = 0.3 # Adjust this value to control the steering sensitivity
    ...
    def run(self):  
        ...
        while self.driver.step() != -1:
            ...
            if step % int(self.TIME_STEP / BASIC_TIME_STEP) == 0:
               ...
               # cv2.resizeWindow(self.camera_window_name, 700, 300)
                ...
                #cv2.imshow(self.camera_window_name, cv_image_bgr)
                cv2.waitKey(1) 
                if state == "RED":
